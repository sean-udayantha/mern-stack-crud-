...
export default class OneGuide extends Component {
...
const {firstName,lastName,age,phone,gender,licence,education,languages} = this.state.guide;
  ...
  return(
    ...
    <button type="submit" class="btn btn-primary" ><a href="/guide" style={{textDecoration:'none' ,color:'white'}} >Back</a></button>
    &nbsp;&nbsp;&nbsp;
        <button type="submit" class="btn btn-primary" ><a href="#" style={{textDecoration:'none' ,color:'white'}} >Request</a></button>
